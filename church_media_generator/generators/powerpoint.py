...
def _build_slide_theme(liturgical_color: Optional[Mapping[str, Any]]) -> SlideTheme:
    """
...
def _add_hymn_lyric_slides(
    ...
    title_box = slide0.shapes.add_textbox(MARGIN_SIDE, title_top, w, Inches(0.85))
...
def generate_mass_ppt(
    ...
    *,
    ...
    theme = _build_slide_theme(liturgical_color)
    ...
    if not off_id or not _try_library_hymn(prs, "offertory", off_id, "Offertory", theme):
        _add_marked_chunked(prs, "Liturgy of the Eucharist", GFCC.OFFERTORY_HYMN, theme)
